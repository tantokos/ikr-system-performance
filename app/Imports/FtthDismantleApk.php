...
use App\Models\ImportFtthDismantleApk;
...
class FtthDismantleApk implements ToModel, WithHeadingRow, WithValidation, WithChunkReading
{
    ...
    {
        return new ImportFtthDismantleApk([
            'wo_no' => $row['wo_no'],
