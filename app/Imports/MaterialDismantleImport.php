...
use App\Models\ImportFtthDismantleMaterial;
use Maatwebsite\Excel\Concerns\WithChunkReading;
use Maatwebsite\Excel\Concerns\WithHeadingRow;
use Maatwebsite\Excel\Concerns\WithValidation;

class MaterialDismantleImport implements ToModel, WithHeadingRow, WithChunkReading, WithValidation
{
    ...
    */
    ...
    public function model(array $row)
    {
        ...
        return new ImportFtthDismantleMaterial([
            'wo_no' => $row['wo_no'],
            'wo_date' => $row['wo_date'],
    ...
    {
        return [
            'no_wo_apk' => Rule::unique('import_ftth_dismantle_materials', 'no_wo_apk')
        ];
    }
