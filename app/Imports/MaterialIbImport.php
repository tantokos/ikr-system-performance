...
use App\Models\ImportFtthIbMaterial;
...
class MaterialIbImport implements ToModel, WithHeadingRow, WithChunkReading, WithValidation
{
    ...
    public function model(array $row)
    {
        ...
        return new ImportFtthIbMaterial([
            'wo_no' => $row['wo_no'],
            'wo_date' => $row['wo_date'],
