                ...
                if (count($dtImportAssign) > 0) {
                    ...
                    try {
                        ...
                        foreach ($dtImportAssign as $data) {
                            ...
                            $AssignBaru[] = ['no_wo_apk' => $data['no_wo_apk'], 'tgl_ikr' => $data['tgl_ikr'],
                            ...
                            if ($data['type_wo'] == "FTTH Maintenance") {
                                    // DB::table('data_ftth_mt_oris')->insert([
                                        array_push($AssignBaruMT, ['no_wo' => $data['no_wo_apk'], 'tgl_ikr' => $data['tgl_ikr'],                                            
                                            'type_wo' => $data['type_wo'],                                        
                                    ...
                                    // DB::table('data_ftth_ib_oris')->insert([
                                        array_push($AssignBaruIB, 
                                        ['no_wo' => $data['no_wo_apk'],'tgl_ikr' => $data['tgl_ikr'],
                                    ...
                                    // DB::table('data_ftth_dismantle_oris')->insert([
                                        array_push($AssignBaruDis, 
                                        ['no_wo' => $data['no_wo_apk'], 'visit_date' => $data['tgl_ikr'],
                                        'sesi' => $data['batch_wo'],
                        ...
                        if(count($AssignBaru)>0) {
                            ...
                            $insertAssign = DB::table('data_assign_tims')->upsert($AssignBaru, 
                                            ['no_wo_apk', 'tgl_ikr'],
                                            ['batch_wo', 'slot_time', 'type_wo', 'no_ticket_apk', 'wo_date_apk',
                                                'cust_id_apk', 'name_cust_apk', 'cust_phone_apk', 'cust_mobile_apk',
                                                'address_apk', 'area_cluster_apk', 'wo_type_apk', 'fat_code_apk',
                                                'fat_port_apk', 'remarks_apk', 'vendor_installer_apk', 'ikr_date_apk',
                                                'time_apk', 'branch_id', 'branch', 'leadcall_id', 'leadcall', 'leader_id',
                                                'leader', 'callsign_id', 'callsign', 'tek1_nik', 'teknisi1', 'tek2_nik', 'teknisi2',
                                                'tek3_nik', 'teknisi3', 'tek4_nik', 'teknisi4', 'login_id', 'login', "created_at", "updated_at"
                                            ]);
                            dd(DB::getQueryLog(), DB::getRawQueryLog());
                        }
                        if(count($AssignBaruMT)>0) {
                            // $insertMt = DB::table('data_ftth_mt_oris')->insert($AssignBaruMT);
                            $insertMt = FtthMt::upsert($AssignBaruMT, 
                                            ['no_wo','tgl_ikr'],
                                            ['type_wo' => $data['type_wo'],                                        
                                                'no_ticket', 'cust_id', 'nama_cust', 'cust_address1', 'cust_address2', 'type_maintenance',
                                                'kode_fat', 'kode_wilayah', 'cluster', 'kotamadya', 'kotamadya_penagihan', 'branch_id',
                                                'branch', 'slot_time_leader', 'slot_time_apk', 'sesi', 'callsign', 'leader', 
                                                'teknisi1', 'teknisi2', 'teknisi3', 'ms_regular', 'wo_date_apk', 'slot_time_assign_apk',
                                                'port_fat', 'site_penagihan', 'wo_type_apk', 'leadcall_id', 'leadcall', 'leader_id',
                                                'callsign_id', 'tek1_nik', 'tek2_nik', 'tek3_nik', 'tek4_nik', 'teknisi4', 'login', "created_at", "updated_at"
                                            ]); 
                        }
                        if(count($AssignBaruIB)>0) {
                            // $insertIB = DB::table('data_ftth_ib_oris')->insert($AssignBaruIB);
                            $insertIB = FtthIb::upsert($AssignBaruIB, 
                                            ['no_wo', 'tgl_ikr'],
                                            ['site', 'type_wo', 'wo_type_apk', 'no_ticket', 'cust_id', 'nama_cust', 'cust_address1',
                                                'type_maintenance', 'kode_fat', 'kode_wilayah', 'cluster', 'kotamadya', 'kotamadya_penagihan',
                                                'branch_id', 'branch', 'leadcall_id', 'leadcall', 'slot_time_leader', 'slot_time_apk', 'sesi',
                                                'callsign', 'callsign_id', 'leader_id', 'leader', 'tek1_nik', 'tek2_nik', 'tek3_nik',
                                                'tek4_nik', 'teknisi1', 'teknisi2', 'teknisi3', 'teknisi4', 'wo_date_apk', 'port_fat',
                        ...
                        if(count($AssignBaruDis)>0) {
                            ...
                            $insertDis = FtthDismantle::upsert($AssignBaruDis,
                                            ['no_wo', 'visit_date'],
                                            ['sesi', 'type_wo', 'no_ticket', 'wo_date', 'cust_id', 'nama_cust', 'cust_address1',
                                                'cluster', 'wo_type_apk', 'kode_fat', 'port_fat', 'slot_time_leader', 'slot_time_apk',
                                                'branch_id', 'main_branch', 'leadcall_id', 'leadcall', 'leader_id', 'leader',
                                                'callsign_id', 'callsign', 'tek1_nik', 'teknisi1', 'tek2_nik', 'teknisi2',
                                                'tek3_nik', 'teknisi3', 'login', "created_at", "updated_at"
                                            ]);
                        }

                        //update selurun callsign tim di data assign tim jika ada perubahan tim di callsign
                        foreach ($dtImportCallsign as $impCallsign ) { 
                            // array_push($updateCallsign, 
                            //         ['tgl_ikr' => $impCallsign['tgl_ikr'], 'callsign' => $impCallsign['callsign'],
                            //             'leadcall_id' => $impCallsign['leadcall_id'], 'leadcall' => $impCallsign['leadcall'],
                            //             'leader_id' => $impCallsign['leader_id'], 'leader' => $impCallsign['leader'],
                            //             'callsign_id' => $impCallsign['callsign_id'], 'callsign' => $impCallsign['callsign'],
                            //             'tek1_nik' => $impCallsign['tek1_nik'], 'teknisi1' => $impCallsign['teknisi1'],
                            //             'tek2_nik' => $impCallsign['tek2_nik'], 'teknisi2' => $impCallsign['teknisi2'],
                            //             'tek3_nik' => $impCallsign['tek3_nik'], 'teknisi3' => $impCallsign['teknisi3'],
                            //             'tek4_nik' => $impCallsign['tek4_nik'], 'teknisi4' => $impCallsign['teknisi4']
                            //         ]);


                            // $updateDtCallsign = DataAssignTim::where('tgl_ikr', $impCallsign['tgl_ikr'])
                            $updateDtCallsign = DB::table('data_assign_tims')->where('tgl_ikr', $impCallsign['tgl_ikr'])
                            ...
                            // $updateMTDtCallsign = FtthMt::where('tgl_ikr', $impCallsign['tgl_ikr'])
                            $updateMTDtCallsign = DB::table('data_ftth_mt_oris')->where('tgl_ikr', $impCallsign['tgl_ikr'])
                                    ->where('callsign', $impCallsign['callsign'])
                                    ->update(['leadcall_id' => $impCallsign['leadcall_id'],
                                                'leadcall' => $impCallsign['leadcall'],
                                                'leader_id' => $impCallsign['leader_id'],
                            ...
                            // $updateIBDtCallsign = FtthIb::where('tgl_ikr', $impCallsign['tgl_ikr'])
                            $updateIBDtCallsign = DB::table('data_ftth_ib_oris')->where('tgl_ikr', $impCallsign['tgl_ikr'])
                                    ->where('callsign', $impCallsign['callsign'])
                                    ->update(['leadcall_id' => $impCallsign['leadcall_id'],
                                                'leadcall' => $impCallsign['leadcall'],
                                                'leader_id' => $impCallsign['leader_id'],
                            ...
                            //  $updateDisDtCallsign = FtthDismantle::where('visit_date', $impCallsign['tgl_ikr'])
                             $updateDisDtCallsign = DB::table('data_ftth_dismantle_oris')->where('visit_date', $impCallsign['tgl_ikr'])
                                    ->where('callsign', $impCallsign['callsign'])
                                    ->update(['leadcall_id' => $impCallsign['leadcall_id'],
                                                'leadcall' => $impCallsign['leadcall'],
                                                'leader_id' => $impCallsign['leader_id'],
