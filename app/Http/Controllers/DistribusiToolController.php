...
class DistribusiToolController extends Controller
{
    ...
    {
        $Leadcallsign = DB::table('v_detail_callsign_tim')->select('lead_call_id', 'lead_callsign', 'nama_branch')->distinct()->orderBy('lead_callsign')->orderBy('branch_id')->get();
    ...
    {
        // dd($request->all());
        $datas = DB::table('data_distribusi_tools')
