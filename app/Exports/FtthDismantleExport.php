    ...
    */
    ...
    public function collection()
    {
        ...
        $datas = DB::table('data_ftth_dismantle_oris as d')
            ...
            DB::raw('(SELECT CASE WHEN material_condition = "Lost In Customer" THEN "Lost In Customer" ELSE description END FROM ftth_dismantle_materials WHERE wo_no = d.no_wo AND status_item = "IN" AND description LIKE "%ONT%" LIMIT 1) as ont_merk_in'),
            ...
            DB::raw('(SELECT CASE WHEN material_condition = "Lost In Customer" THEN "Lost In Customer" ELSE description END FROM ftth_dismantle_materials WHERE wo_no = d.no_wo AND status_item = "IN" AND description LIKE "%ROUTER%" LIMIT 1) as merk_router_in'),
            ...
            DB::raw('(SELECT CASE WHEN material_condition = "Lost In Customer" THEN "Lost In Customer" ELSE description END FROM ftth_dismantle_materials WHERE wo_no = d.no_wo AND status_item = "IN" AND description LIKE "%STB%" LIMIT 1) as stb_merk_in'),
