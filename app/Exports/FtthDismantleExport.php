    ...
    */
    ...
    public function collection()
    {
        ...
        $datas = DB::table('data_ftth_dismantle_oris as d')
            ...
            DB::raw("'' as jumlah_material"),
            DB::raw("'' as merk_ont_out"),
            DB::raw("'' as sn_ont_out"),
            DB::raw("'' as mac_ont_out"),
            DB::raw("'' as merk_ont_in"),
            DB::raw("'' as sn_ont_in"),
            DB::raw("'' as mac_ont_in"),
            ...
            DB::raw("'' as merk_stb_out"),
            DB::raw("'' as sn_stb_out"),
            DB::raw("'' as mac_stb_out"),
            DB::raw("'' as merk_stb_in"),
            DB::raw("'' as sn_stb_in"),
            DB::raw("'' as remote_fiberhome"),
            DB::raw("'' as remote_extrem"),
            DB::raw("'' as dw_out"),
            DB::raw("'' as precon_out"),
            DB::raw("'' as precon_in"),
