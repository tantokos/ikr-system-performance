                ...
                <div class="col-12">
                    <div class="card card-background card-background-after-none align-items-start mt-2 mb-5">
                        ...
                        <div class="card-body text-start p-4 w-100">
                            <h3 class="text-white mb-2">Pengembalian Tool IKR</h3>
                            ...
                            <div class="d-sm-flex align-items-center">
                                ...
                                <div class="ms-auto d-flex">
                                    <button type="button"
                                        ...
                                        <span class="btn-inner--text">Tambah Pengembalian Tool</span>
                                    </button>
                                </div>
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Pengembalian Tool</h5>
                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('simpanPengembalian') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col">
