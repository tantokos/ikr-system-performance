    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabelMaterial">Edit Material Dismantle</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('updateMaterialDismantle') }}" class="updateMaterialDismantle" method="POST"
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <select class="form-control form-control-sm" type="text" id="status_item"
                                    name="status_item" style="border-color:#9ca0a7;">
