                ...
                <div class="col-12">
                    <div class="card card-background card-background-after-none align-items-start mt-2 mb-2">
                        ...
                        <div class="card-body text-start p-4 w-100">
                            <h3 class="text-white mb-2">Import Dismantle Material APK</h3>
            ...
            <div class="card card-frame mb-2">
                <div class="card-body shadow-sm border border-radius-sm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form action="{{ route('importDismantleProsesMaterial') }}" method="post"
                        ...
                        <div class="col-md-6">
                            <form action="{{ route('storeDismantleMaterial') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
    ...
    $(document).ready(function() {
        ...
        function data_import() {
            $('#tableImportMaterial').DataTable({
                ...
                serverSide: false,
                ajax: {
                    url: "{{ route('getDataImportMaterialDismantle') }}",
                    type: "get",
                    dataType: "json",
                    data: {
                        akses: akses,
