                ...
                <div class="col-12">
                    <div class="card card-background card-background-after-none align-items-start mt-2 mb-3">
                        ...
                        <div class="card-body text-start p-4 w-100">
                            <h3 class="text-white mb-2">Update Data Seragam IKR</h3>
                            ...
                            <div class="d-sm-flex align-items-center">
                                ...
                                <div class="ms-auto d-flex">
                                    <button type="button"
                                        ...
                                        <span class="btn-inner--text">Tambah Update Seragam</span>
                                    </button>
                                </div>
                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Update Kondisi Seragam</h5>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="form-group mb-1">
                                                    <span class="text-xs">Tgl Update</span>
                                                    <input class="form-control form-control-sm" type="date"
                                                        value="{{ date('Y-m-d') }}" id="tglUpdate"
                                                        name="tglUpdate" style="border-color:#9ca0a7;">
                                                </div>
                                            ...
                                            <div class="col">
                                                <div class="row form-group mb-1">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <input type="number"
                                                            ...
                                                            id="jmlSShow" value="0" name="jml[]"
                                                            style="border-color:#9ca0a7;" min="0" max="0">
                                                    </div>
                                                </div>                                                
                                                ...
                                                <div class="row form-group mb-1">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <input type="number"
                                                            class="form-control form-control-sm jmlDistribusi"
                                                            id="jmlXXLShow" value="0" name="jml[]"
                                                            style="border-color:#9ca0a7;" min="0" max="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row form-group mb-1">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <input type="number"
                                                            class="form-control form-control-sm jmlDistribusi"
                                                            id="jmlXXXLShow" value="0" name="jml[]"
                                                            style="border-color:#9ca0a7;" min="0" max="0">
                                                    </div>
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="form-group mb-1">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <ul>
                                                                <li><span class="text-xs" id="stockS">S =</span>
                                                                </li>
                                                                <li><span class="text-xs" id="stockM">M =</span>
                                                                </li>
                                                                <li><span class="text-xs" id="stockL">L =</span>
                                                                </li>
                                                        ...
                                                        <div class="col">
                                                            <ul>
                                                                <li><span class="text-xs" id="stockXL">XL = </span>
                                                                </li>
                                                                <li><span class="text-xs" id="stockXXL">XXL = </span>
                                                                </li>
                                                                <li><span class="text-xs" id="stockXXXL">XXXL = </span>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('change', '#namapenerima', function(e) {
            ...
            $.ajax({
                url: "{{ route('getStockTeknisi')}}",
                type: "get",
                data: {
                    _token: _token,
                    dtNik: dtNik,
                },
                success: function(dtStock) {
                    console.log(dtStock);
                    jmlSrg = 0;
                    for (x = 0; x < dtStock.length; x++) {
                        if (dtStock[x].ukuran === "S") {
                            $('#kondisiSShow').val(dtStock[x].kondisi)
                            $('#jmlSShow').val(dtStock[x].jml)
                            $('#stockS').text(" S = " + dtStock[x].jml)
                            $('#jmlSShow').attr({"min":0, "max": dtStock[x].jml });

                        }
                        if (dtStock[x].ukuran === "M") {
                            $('#kondisiMShow').val(dtStock[x].kondisi)
                            $('#jmlMShow').val(dtStock[x].jml)
                            $('#stockM').text(" M = " + dtStock[x].jml)
                            $('#jmlMShow').attr({"min":0, "max": dtStock[x].jml });
                        }
                        if (dtStock[x].ukuran === "L") {
                            $('#kondisiLShow').val(dtStock[x].kondisi)
                            $('#jmlLShow').val(dtStock[x].jml)
                            $('#stockL').text(" L = " + dtStock[x].jml)
                            $('#jmlLShow').attr({"min":0, "max": dtStock[x].jml });
                        }
                        if (dtStock[x].ukuran === "XL") {
                            $('#kondisiXLShow').val(dtStock[x].kondisi)
                            $('#jmlXLShow').val(dtStock[x].jml)
                            $('#stockXL').text(" XL = " + dtStock[x].jml)
                            $('#jmlXLShow').attr({"min":0, "max": dtStock[x].jml });
                        }
                        if (dtStock[x].ukuran === "XXL") {
                            $('#kondisiXXLShow').val(dtStock[x].kondisi)
                            $('#jmlXXLShow').val(dtStock[x].jml)
                            $('#stockXXL').text(" XXL = " + dtStock[x].jml)
                            $('#jmlXXLShow').attr({"min":0, "max": dtStock[x].jml });
                        }
                        if (dtStock[x].ukuran === "XXXL") {
                            $('#kondisiXXXLShow').val(dtStock[x].kondisi)
                            $('#jmlXXXLShow').val(dtStock[x].jml)
                            $('#stockXXXL').text(" XXXL = " + dtStock[x].jml)
                            $('#jmlXXXLShow').attr({"min":0, "max": dtStock[x].jml });
                        }
                        jmlSrg = jmlSrg + dtStock[x].jml;
                    }
